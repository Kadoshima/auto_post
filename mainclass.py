...
#画像追加の作成
ImgButton1 = tk.Button(text="画像選択", command=lambda: img1.imgset(img1.file_dialog(0), 0))
ImgButton1.place(x=200, y=390)

#画像追加の作成
ImgButton2 = tk.Button(text="画像選択", command=lambda: img2.imgset(img2.file_dialog(1), 1))
ImgButton2.place(x=450, y=390)

#投稿ボタンの作成
PostButton = tk.Button(text="投稿", command=button_click)
